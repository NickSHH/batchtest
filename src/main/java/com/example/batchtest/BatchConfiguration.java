...
public class BatchConfiguration {
    ...
    protected Step step1(@Qualifier("itemReader") ItemReader<Book> reader,
                         ...
                         @Qualifier("BookReadListener") ItemReadListener readListener,
                         @Qualifier("BookProcessListener") ItemProcessListener processListener,
                         @Qualifier("BookWriterListener") ItemWriteListener writeListener) {
